    ...
    override fun filter(text: AnnotatedString): TransformedText {
        ...
        return TransformedText(AnnotatedString(transformation.formatted ?: ""), object :
            ...
            override fun originalToTransformed(offset: Int): Int {
                return transformation.originalToTransformed[min(offset,transformation.originalToTransformed.size)]
            }
            override fun transformedToOriginal(offset: Int): Int {
                return transformation.transformedToOriginal[min(offset,transformation.originalToTransformed.size)]
            }
        })
    }
